...
exports.createArticleComment = async (req, res, next) => {
    try {
        ...
        const comment = await articleService.createArticleComment(Number(articleId), commentPayload.comment, callee.userId);
...
exports.updateArticleComment = async (req, res, next) => {
    try {
        ...
        const comment = await articleService.updateArticleComment(Number(articleCommentId), commentPayload.comment, callee.userId);
        res.status(200).json(comment);
    } catch (error) {
        next(error);
    }
...
exports.deleteArticleComment = async (req, res, next) => {
    try {
        ...
        await articleService.deleteArticleComment(Number(articleCommentId))
...
exports.getArticleCommentsByArticleIdAndPetOwnerId = async (req, res, next) => {
    try {
        ...
        const response = await articleService.getArticleCommentsByArticleIdAndPetOwnerId(Number(articleId), Number(petOwnerId))
