/*
  ...
  - Added the required column `attachmentKey` to the `OrderItem` table without a default value. This is not possible if the table is not empty.
  - Added the required column `attachmentURL` to the `OrderItem` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "OrderItem" ADD COLUMN     "attachmentKey" TEXT NOT NULL,
ADD COLUMN     "attachmentURL" TEXT NOT NULL;
